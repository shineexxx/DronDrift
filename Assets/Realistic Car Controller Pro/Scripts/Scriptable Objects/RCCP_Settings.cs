...
public class RCCP_Settings : ScriptableObject {
    ...
    [Range(.005f, .06f)] public float fixedTimeStep = .02f;     //  Overriden fixed timestep value.
    public bool overrideAutoSyncTransforms = true;      //  Override autoSyncTransforms in the Project Settings --> Physics.
    public bool autoSyncTransforms = true;      //  Auto sync transform setting in the Project Settings --> Physics.
    ...
    public bool useNiloCatShaderExtension = false;
