...
public class RCCP_VehicleUpgrade_CustomizationManager : RCCP_UpgradeComponent, IRCCP_UpgradeComponent {
    ...
    public void SetHeadlightsColor(Color color) {
        ...
        foreach (RCCP_Light l in CarController.Lights.lights) {
            ...
            if (l != null && l.lightType == RCCP_Light.LightType.Headlight_LowBeam || l.lightType == RCCP_Light.LightType.Headlight_HighBeam)
    ...
    public void SetFrontSuspensionsTargetPos(float targetPosition) {
        ...
        if (CarController.FrontAxle.leftWheelCollider) {
            ...
            JointSpring spring1 = CarController.FrontAxle.leftWheelCollider.WheelCollider.suspensionSpring;
            spring1.targetPosition = 1f - targetPosition;

            CarController.FrontAxle.leftWheelCollider.WheelCollider.suspensionSpring = spring1;

        }

        if (CarController.FrontAxle.rightWheelCollider) {

            JointSpring spring1 = CarController.FrontAxle.rightWheelCollider.WheelCollider.suspensionSpring;
            spring1.targetPosition = 1f - targetPosition;

            CarController.FrontAxle.rightWheelCollider.WheelCollider.suspensionSpring = spring1;
    ...
    public void SetRearSuspensionsTargetPos(float targetPosition) {
        ...
        if (CarController.RearAxle.leftWheelCollider) {
            ...
            JointSpring spring1 = CarController.RearAxle.leftWheelCollider.WheelCollider.suspensionSpring;
            spring1.targetPosition = 1f - targetPosition;

            CarController.RearAxle.leftWheelCollider.WheelCollider.suspensionSpring = spring1;

        }

        if (CarController.RearAxle.rightWheelCollider) {

            JointSpring spring1 = CarController.RearAxle.rightWheelCollider.WheelCollider.suspensionSpring;
            spring1.targetPosition = 1f - targetPosition;

            CarController.RearAxle.rightWheelCollider.WheelCollider.suspensionSpring = spring1;
    ...
    public void SetFrontSuspensionsSpringDamper(float targetValue) {
        ...
        if (!CarController.FrontAxle.leftWheelCollider || !CarController.RearAxle.rightWheelCollider)
            return;
