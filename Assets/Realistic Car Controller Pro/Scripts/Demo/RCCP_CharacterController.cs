...
/// </summary>
[AddComponentMenu("BoneCracker Games/Realistic Car Controller Pro/Misc/RCCP Animator Controller")]
public class RCCP_CharacterController : MonoBehaviour {

    private RCCP_CarController carController;      //  Car controller.
