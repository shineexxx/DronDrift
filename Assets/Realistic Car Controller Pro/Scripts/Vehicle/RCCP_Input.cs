...
public class RCCP_Input : RCCP_Component {
    ...
    public bool overrideInternalInputs = false;     //  Overrides the internal inputs such as throttle, brake, steer, handbrake, nos inputs, etc...
    public bool overrideExternalInputs = false;     //  Overrides the external inputs such as counter steer, reverse gear, etc...
    ...
    public bool autoReverse = true;     //  Gearbox will be called for reverse gear if player applies the brake input while vehicle is stopped.
