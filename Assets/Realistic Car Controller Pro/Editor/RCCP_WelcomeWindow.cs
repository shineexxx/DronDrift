...
public class RCCP_WelcomeWindow : EditorWindow {
    ...
    public static void DemosPageContent() {
        ...
        if (GUILayout.Button("RCCP City AIO"))
            EditorSceneManager.OpenScene(RCCP_DemoScenes.Instance.GetAssetPath(RCCP_DemoScenes.Instance.city_AIO), OpenSceneMode.Single);

        if (GUILayout.Button("RCCP City"))
            EditorSceneManager.OpenScene(RCCP_DemoScenes.Instance.GetAssetPath(RCCP_DemoScenes.Instance.demo_City), OpenSceneMode.Single);

        if (GUILayout.Button("RCCP City Car Selection"))
            EditorSceneManager.OpenScene(RCCP_DemoScenes.Instance.GetAssetPath(RCCP_DemoScenes.Instance.demo_CarSelection), OpenSceneMode.Single);

        if (GUILayout.Button("RCCP Blank API"))
            EditorSceneManager.OpenScene(RCCP_DemoScenes.Instance.GetAssetPath(RCCP_DemoScenes.Instance.demo_APIBlank), OpenSceneMode.Single);

        if (GUILayout.Button("RCCP Blank"))
            EditorSceneManager.OpenScene(RCCP_DemoScenes.Instance.GetAssetPath(RCCP_DemoScenes.Instance.demo_BlankMobile), OpenSceneMode.Single);

        if (GUILayout.Button("RCCP Damage"))
            EditorSceneManager.OpenScene(RCCP_DemoScenes.Instance.GetAssetPath(RCCP_DemoScenes.Instance.demo_Damage), OpenSceneMode.Single);

        if (GUILayout.Button("RCCP Customization"))
            EditorSceneManager.OpenScene(RCCP_DemoScenes.Instance.GetAssetPath(RCCP_DemoScenes.Instance.demo_Customization), OpenSceneMode.Single);

        if (GUILayout.Button("RCCP Override Inputs"))
            EditorSceneManager.OpenScene(RCCP_DemoScenes.Instance.GetAssetPath(RCCP_DemoScenes.Instance.demo_OverrideInputs), OpenSceneMode.Single);

        if (GUILayout.Button("RCCP Transport"))
            EditorSceneManager.OpenScene(RCCP_DemoScenes.Instance.GetAssetPath(RCCP_DemoScenes.Instance.demo_Transport), OpenSceneMode.Single);
        ...
        if (GUILayout.Button("RCCP City Enter-Exit FPS"))
            EditorSceneManager.OpenScene(RCCP_DemoScenes.Instance.GetAssetPath(RCCP_DemoScenes.Instance.demo_CityFPS), OpenSceneMode.Single);

        if (GUILayout.Button("RCCP City Enter-Exit TPS"))
            EditorSceneManager.OpenScene(RCCP_DemoScenes.Instance.GetAssetPath(RCCP_DemoScenes.Instance.demo_CityTPS), OpenSceneMode.Single);
        ...
        if (GUILayout.Button("RCCP Lobby Photon"))
            EditorSceneManager.OpenScene(RCCP_DemoScenes.Instance.GetAssetPath(RCCP_DemoScenes.Instance.demo_PUN2Lobby), OpenSceneMode.Single);

        if (GUILayout.Button("RCCP Blank Photon"))
            EditorSceneManager.OpenScene(RCCP_DemoScenes.Instance.GetAssetPath(RCCP_DemoScenes.Instance.demo_PUN2City), OpenSceneMode.Single);
        ...
        if (GUILayout.Button("RCCP City Traffic") && RCCP_DemoScenes.Instance.demo_City_Traffic != null)
            EditorSceneManager.OpenScene(RCCP_DemoScenes.Instance.GetAssetPath(RCCP_DemoScenes.Instance.demo_City_Traffic), OpenSceneMode.Single);
    ...
    private static void DeleteDemoContent() {
        ...
        foreach (var item in RCCP_DemoContent.Instance.contents) {
            ...
            if (item != null)
                FileUtil.DeleteFileOrDirectory(RCCP_DemoContent.Instance.GetAssetPath(item));
    ...
    private static void AddDemoScenesToBuildSettings() {
        ...
        demoScenePaths.Add(RCCP_DemoScenes.Instance.GetAssetPath(RCCP_DemoScenes.Instance.city_AIO));
        demoScenePaths.Add(RCCP_DemoScenes.Instance.GetAssetPath(RCCP_DemoScenes.Instance.demo_City));
        demoScenePaths.Add(RCCP_DemoScenes.Instance.GetAssetPath(RCCP_DemoScenes.Instance.demo_CarSelection));
        demoScenePaths.Add(RCCP_DemoScenes.Instance.GetAssetPath(RCCP_DemoScenes.Instance.demo_APIBlank));
        demoScenePaths.Add(RCCP_DemoScenes.Instance.GetAssetPath(RCCP_DemoScenes.Instance.demo_BlankMobile));
        demoScenePaths.Add(RCCP_DemoScenes.Instance.GetAssetPath(RCCP_DemoScenes.Instance.demo_Damage));
        demoScenePaths.Add(RCCP_DemoScenes.Instance.GetAssetPath(RCCP_DemoScenes.Instance.demo_Customization));
        demoScenePaths.Add(RCCP_DemoScenes.Instance.GetAssetPath(RCCP_DemoScenes.Instance.demo_OverrideInputs));
        demoScenePaths.Add(RCCP_DemoScenes.Instance.GetAssetPath(RCCP_DemoScenes.Instance.demo_Transport));

#if BCG_ENTEREXIT

        demoScenePaths.Add(RCCP_DemoScenes.Instance.GetAssetPath(RCCP_DemoScenes.Instance.demo_CityFPS));
        demoScenePaths.Add(RCCP_DemoScenes.Instance.GetAssetPath(RCCP_DemoScenes.Instance.demo_CityTPS));

#endif

#if RCCP_PHOTON && PHOTON_UNITY_NETWORKING

        demoScenePaths.Add(RCCP_DemoScenes.Instance.GetAssetPath(RCCP_DemoScenes.Instance.demo_PUN2Lobby));
        demoScenePaths.Add(RCCP_DemoScenes.Instance.GetAssetPath(RCCP_DemoScenes.Instance.demo_PUN2City));

#endif

#if BCG_RTRC

        if (RCCP_DemoScenes.Instance.demo_City_Traffic != null)
            demoScenePaths.Add(RCCP_DemoScenes.Instance.GetAssetPath(RCCP_DemoScenes.Instance.demo_City_Traffic));
