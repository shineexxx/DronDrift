...
public class RCCP_DemoMaterialsEditor : Editor {
    ...
    public override void OnInspectorGUI() {
        ...
        if (GUILayout.Button("Select All Demo Materials For Converting To URP (Except vehicle body materials)"))
            EditorApplication.ExecuteMenuItem("Tools/BoneCracker Games/Realistic Car Controller Pro/URP/To URP/Convert All Demo Materials To URP");

        if (GUILayout.Button("Convert All Demo Vehicle Body Shaders To URP Shaders"))
            EditorApplication.ExecuteMenuItem("Tools/BoneCracker Games/Realistic Car Controller Pro/URP/To URP/Convert All Demo Vehicle Body Materials To URP");
        ...
        if (GUILayout.Button("Select All Demo Materials For Converting To Builtin (Except vehicle body materials)"))
            EditorApplication.ExecuteMenuItem("Tools/BoneCracker Games/Realistic Car Controller Pro/URP/To Builtin/Convert All Demo Materials To Builtin");

        if (GUILayout.Button("Convert All Demo Vehicle Body Shaders To Builtin Shaders"))
            EditorApplication.ExecuteMenuItem("Tools/BoneCracker Games/Realistic Car Controller Pro/URP/To Builtin/Convert All Demo Vehicle Body Materials To Builtin");
