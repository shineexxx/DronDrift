...
public class RCCP_Camera : MonoBehaviour {
    ...
    private void Inputs() {
        ...
        //  Don't proccess any inputs before 1 second.
    ...
    public IEnumerator AutoFocus() {
        ...
        while (timer > 0f) {
            ...
            TPSDistance = Mathf.MoveTowards(TPSDistance, bounds * 2.8f, Time.deltaTime * 2f);
            TPSHeight = Mathf.MoveTowards(TPSHeight, bounds * .65f, Time.deltaTime * 2f);
            yield return null;
