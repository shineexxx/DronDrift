...
public class RCCP_Engine : RCCP_Component {
    ...
    public bool overrideEngineRPM = false;      //  Overrides the engine rpm with given rpm value. All calculations will be ignored.
    ...
    internal float wantedEngineRPMRaw = 0f;      //  Wanted actual engine rpm. This value will be smoothed.
    ...
    internal float turboChargePsi_Old = 0f;      //  Previous supercharger psi.
