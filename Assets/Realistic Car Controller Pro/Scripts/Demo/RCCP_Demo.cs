...
public class RCCP_Demo : MonoBehaviour {
    ...
    [SerializeField] private int selectedVehicleIndex = 0;      // An integer index value used for spawning a new vehicle.
    ...
    public void Spawn() {
        ...
        if (currentVehicle) {
            ...
            if (enterExitVehicle) {
                ...
                StartCoroutine(CheckBCGEnterExitVehicles());
...
#if BCG_ENTEREXIT
    private IEnumerator CheckBCGEnterExitVehicles() {
