...
public class RCCP_DamageEditor : Editor {
    ...
    public override void OnInspectorGUI() {
        ...
        EditorGUILayout.PropertyField(serializedObject.FindProperty("saveName"), new GUIContent("Save Name", "This string will be used to save and load the damage data siwth json."));
    ...
    public void GetMeshes() {
        ...
        MeshFilter[] allMeshFilters = prop.GetComponentInParent<RCCP_CarController>(true).gameObject.GetComponentsInChildren<MeshFilter>(true);
