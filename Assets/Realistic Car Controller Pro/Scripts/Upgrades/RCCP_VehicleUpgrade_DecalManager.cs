...
public class RCCP_VehicleUpgrade_DecalManager : RCCP_UpgradeComponent, IRCCP_UpgradeComponent {
    ...
    //  Indexes of decals.
    public int index_decalFront = -1;
    public int index_decalBack = -1;
    public int index_decalLeft = -1;
    public int index_decalRight = -1;

    public Material[] decals;       //  Decal materials.
    public Material decal_Null;     //  Empty material.
    ...
    public void Initialize() {
        ...
        //  Setting all decals materials to null.
    ...
    public void EnableAll() {
        ...
        //  If index is not -1, set material of the decal by the loadout.
        decalFront.SetDecal(decals[0]);
        decalBack.SetDecal(decals[0]);
        decalLeft.SetDecal(decals[0]);
        decalRight.SetDecal(decals[0]);
