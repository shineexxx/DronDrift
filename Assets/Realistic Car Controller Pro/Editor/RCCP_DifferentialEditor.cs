...
public class RCCP_DifferentialEditor : Editor {
    ...
    public override void OnInspectorGUI() {
        ...
        if (prop.connectedAxle == null) {
            ...
            if (prop.GetComponentInParent<RCCP_CarController>(true).GetComponentInChildren<RCCP_Axles>(true) != null && prop.GetComponentInParent<RCCP_CarController>(true).GetComponentInChildren<RCCP_Axles>(true).GetComponentsInChildren<RCCP_Axle>(true) != null) {

                for (int i = 0; i < prop.GetComponentInParent<RCCP_CarController>(true).GetComponentInChildren<RCCP_Axles>(true).GetComponentsInChildren<RCCP_Axle>(true).Length; i++) {

                    if (GUILayout.Button("Connect to " + prop.GetComponentInParent<RCCP_CarController>(true).GetComponentInChildren<RCCP_Axles>(true).GetComponentsInChildren<RCCP_Axle>(true)[i].gameObject.name))
                        prop.connectedAxle = prop.GetComponentInParent<RCCP_CarController>(true).GetComponentInChildren<RCCP_Axles>(true).GetComponentsInChildren<RCCP_Axle>(true)[i];
