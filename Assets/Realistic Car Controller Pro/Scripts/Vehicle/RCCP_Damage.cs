...
public class RCCP_Damage : RCCP_Component {
    ...
    public string saveName = "";        //  Save file name will be used to save / load damage data with json.
    ...
    [System.Serializable] public struct OriginalMeshVerts { public Vector3[] meshVerts; }     // Struct for Original Mesh Verticies positions.
    ...
    public override void Start() {
        ...
        if (automaticInstallation) {
            ...
            parts = CarController.GetComponentsInChildren<RCCP_DetachablePart>(true);
            lights = CarController.GetComponentsInChildren<RCCP_Light>(true);
            wheels = CarController.GetComponentsInChildren<RCCP_WheelCollider>(true);
